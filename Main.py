...
def main():
    def run():
        ...
        if inspect:
            ...
            data_pack = prep.prepare_experiment(stock=stock, prep_id=prep_id, all_data=all_data,
                                                proc_flow_id=proc)

            df_all = data_pack.all_data
            df_test = data_pack.test_data
            df_train = data_pack.train_data
